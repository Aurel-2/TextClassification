...
vectorizer = joblib.load("tfidf_spam.pkl")
models = {
    "naive_bayes": joblib.load("naive_bayes_spam.pkl"),
    "decision_tree": joblib.load("decision_tree_spam.pkl"),
    "logistic_regression": joblib.load("logistic_regression_spam.pkl")
}
